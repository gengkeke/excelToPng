...
public class App {
    public static void test(String path) throws Exception {
        ...
        int imageWidth = 2000;//图片宽度
        int imageHeight = 2000;//图片高度
        ...
        g2d.dispose();
        ImageIO.write(image, "png", new File("E:\\excel2img\\天工大数据-20181126105446622.png"));
    ...
    public static void main(String[] args) throws Exception {
        String path = "E:\\excel2img\\天工大数据-20181126105446622.xlsx";
        test(path);
    }
}
